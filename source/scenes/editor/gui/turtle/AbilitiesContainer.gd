...
#var _potential_user_abilities: Array = TurtleAbilities.potential_user_abilities.keys()
...
#					_potential_user_abilities[ability]
...
#					var ability = _potential_user_abilities[ability_description]
